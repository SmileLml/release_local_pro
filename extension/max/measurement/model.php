...
class measurementModel extends model
{
     ...
     * @return string
     */
    public function getBasicMeasValue($measurementID, $params = '', $action = 'save')
    {
        $measurement = $this->getByID($measurementID);
        return $this->execSqlMeasurement($measurement, $params, $action);
    }
        ...
        if(!empty($matches))
        {
            foreach($matches as $match)
            {
                ...
                if($measurement->type == 'basic')
                {
                    ...
                    $replace[] = $this->getBasicMeasValue($measurement->measurementID, $params, 'view');
                }
                else
                {
