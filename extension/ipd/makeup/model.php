...
class makeupModel extends model
{
     ...
     * @return array 
     */
    public function processStatus($makeupList, $record = null)
    {
    ...
    public function delete($id, $null = null)
    {
        ...
        if(!dao::isError())
        {
            ...
            $this->loadModel('attend')->batchUpdate($oldDates, $oldMakeup->createdBy, '');
        }
        return !dao::isError();
    }
    ...
    public function review($id, $status)
    {
        ...
        if(!dao::isError() and $status == 'pass')
        {
            ...
            $this->loadModel('attend')->batchUpdate($dates, $makeup->createdBy, 'makeup', '', $makeup);
        }
