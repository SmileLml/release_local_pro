<?php
 $canBeChangedByProject = common::canModify('exection', $execution, $project);
?>
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-right">
    ...
    <?php if($canBeChangedByProject and common::hasPriv('execution', 'relation')) echo html::a($this->createLink('execution', 'relation', "executionID=$executionID"), "<i class='icon icon-list-alt muted'></i> " . $lang->execution->maintainRelation, '', "class='btn btn-link'");?>
    <?php endif;?>
    ...
    <?php else:?>
    <?php
      if(common::hasPriv('execution', 'maintainRelation') and $canBeChangedByProject) echo html::a($this->createLink('execution', 'maintainRelation', "executionID=$executionID"), "<i class='icon icon-plus'></i> " . $lang->execution->gantt->editRelationOfTasks, '', "class='btn btn-secondary'");
    ?>
    <?php endif;?>
    <?php
