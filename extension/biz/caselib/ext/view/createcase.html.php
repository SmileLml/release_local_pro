  ...
  <div class='center-block'>
    ...
    <form method='post' enctype='multipart/form-data' id='dataform' target='hiddenwin'>
      <table class='table table-form'>
        ...
        <tr>
          <th><?php echo $lang->testcase->purpose;?></th>
          <td colspan='2'><?php echo html::input('purpose', '', "class='form-control'");?></td>
        </tr>
        <tr>
        ...
        <?php endif;?>
          <tr>
            ...
            <td colspan='2'><?php echo html::select('auto', $lang->testcase->autoList, 'no', "class='form-control'");?>
          </tr>
        <tr>
