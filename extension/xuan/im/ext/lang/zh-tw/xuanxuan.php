...
$lang->im->detachedConferenceUpgradeMessage->newClient->content = '管理員已將會議機制更新，支持 v7.2.beta 及以上版本，為了不影響您的使用體驗，建議您重啟應用我們將更新您的會議機制，詳情請移步禪道官網查看。';
$lang->im->detachedConferenceUpgradeMessage->oldClient->content = '管理員已將會議機制更新，支持 v7.2.beta 及以上版本，為了不影響您的使用體驗，建議您重啟應用我們將更新您的會議機制，請移步禪道官網更新。';
