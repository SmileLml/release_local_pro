...
<?php js::set('programs', $programs);?>
<?php js::set('CRProject', isset($config->CRProject) && empty($config->CRProject) ? 1 : 0);?>
...
<div id='mainContent' class='main-row'>
  ...
  <div class='main-col'>
    <div class="cell<?php if($status == 'bySearch') echo ' show';?>" id="queryBox" data-module='program'></div>
    <?php
    include $app->getModulePath() . 'view/browsebylist.html.php';
    ?>
  </div>
  <?php endif;?>
</div>
