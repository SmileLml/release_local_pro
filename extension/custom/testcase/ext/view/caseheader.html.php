...
<?php
  ...
  if($isProjectApp && isset($project) && !common::canModify('project', $project)) $canBeChangedProject = false;
  if(!$isProjectApp && !common::canModify('projectproduct', $product)) $canBeChangedProject = false;
?>
    ...
    <?php if(!isonlybody()):?>
      <div class='btn-toolbar pull-right'>
        ...
        <?php if(empty($productID) or common::canModify('product', $product)):?>
          <?php if(!$isZeroCase and !empty($productID) and (common::hasPriv('testcase', 'import') or common::hasPriv('testcase', 'importFromLib')) and $canBeChangedProject): ?>
            <div class='btn-group'>
          ...
          <?php endif;?>
          <?php if(!empty($productID) && $canBeChangedProject):?>
            <div class='btn-group'>
