...
<div id='mainMenu' class='clearfix'>
  ...
  <?php if(!isonlybody()):?>
    <div class='btn-toolbar pull-right'>
      ...
      <?php if(common::canBeChanged('testcase', $case) and $canBeChangedByProject) common::printLink('testcase', 'create', "productID={$case->product}&branch={$case->branch}&moduleID={$case->module}", "<i class='icon icon-plus'></i> " . $lang->testcase->create, '', "class='btn btn-primary'"); ?>
    </div>
  <?php endif;?>
</div>
