...
<?php if(empty($docs)):?>
  <div class="table-empty-tip">
    <p>
      ...
      <?php
        if($browseType != 'bySearch' and $libID and $canBeModify and (common::hasPriv('doc', 'create') or (common::hasPriv('api', 'create') and !$apiLibID)))
        {
    ...
    <form class='main-table' method='post' id='docListForm'>
      <table class="table table-files has-sort-head">
        ...
        <tr>
          ...
          <?php if($canBeModify):?><th class="c-actions"><?php echo $lang->actions;?></th><?php endif;?>
        </tr>
        </thead>
        <tbody>
