...
<?php
$canBeModify = !isset($canBeModify) || $canBeModify;
...
<?php
$canAddCatalog['doc'] = common::hasPriv('doc', 'addCatalog') && $canBeModify;
$canAddCatalog['api'] = common::hasPriv('api', 'addCatalog') && $canBeModify;

$canEditCatalog['doc'] = common::hasPriv('doc', 'editCatalog') && $canBeModify;
$canEditCatalog['api'] = common::hasPriv('api', 'editCatalog') && $canBeModify;

$canDeleteCatalog['doc'] = common::hasPriv('doc', 'deleteCatalog') && $canBeModify;
$canDeleteCatalog['api'] = common::hasPriv('api', 'deleteCatalog') && $canBeModify;

$hasModulePriv['doc'] = ($canAddCatalog['doc'] || $canEditCatalog['doc'] || $canDeleteCatalog['doc']) && $canBeModify;
$hasModulePriv['api'] = ($canAddCatalog['api'] || $canEditCatalog['api'] || $canDeleteCatalog['api']) && $canBeModify;

$hasLibPriv['doc'] = ($canAddCatalog['doc'] || common::hasPriv('doc', 'editLib') || common::hasPriv('doc', 'deleteLib')) && $canBeModify;
$hasLibPriv['api'] = ($canAddCatalog['api'] || common::hasPriv('api', 'editLib') || common::hasPriv('api', 'deleteLib')) && $canBeModify;
