    ...
    <div class="cell" id="content">
      <div class="detail no-padding">
        <div class="detail-title no-padding doc-title">
          ...
          <div class="actions">
            <?php if($canBeModify) echo html::a("javascript:fullScreen()", '<span class="icon-fullscreen"></span>', '', "title='{$lang->fullscreen}' class='btn btn-link fullscreen-btn'");?>
            <?php if(common::hasPriv('doc', 'collect') and $canBeModify):?>
            ...
            <?php
            if(common::hasPriv('doc', 'edit') and $canBeModify)
            {
              $iframe   = '';
              $onlybody = false;
            ...
            if(common::hasPriv('doc', 'delete') and $canBeModify)
            {
