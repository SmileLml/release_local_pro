  ...
  <div id="mainMenu" class="clearfix">
    ...
    <?php if(!isonlybody()):?>
      <div class="btn-toolbar pull-right">
        ...
        if(common::hasPriv('task', 'create', $checkObject) and common::canModify('project', $project)) echo html::a($link, "<i class='icon icon-plus'></i> {$lang->task->create}", '', "class='btn btn-primary'");
        ?>
      </div>
    <?php endif;?>
  </div>
