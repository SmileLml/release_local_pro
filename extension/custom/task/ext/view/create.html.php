      ...
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td colspan='3'>
            ...
            if(isset($newTask))
            {
              echo $this->fetch('file', 'printFiles', array('files' => $newTask->files, 'fieldset' => 'false', 'object' => null, 'method' => 'edit', 'showDelete' => true, 'showEdit' => true));
              foreach($newTask->files as $newTaskFileID => $newTaskFile)
              {
                echo html::hidden("newTaskFileID[{$newTaskFileID}]", $newTaskFileID);
              }
            }
            ...
            <div class='modal-body'>
              <table class="table table-form" id='taskTeamEditor'>
                <tbody class='sortable'>
                  <?php include $app->getModulePath() . DS . 'view/taskteam.html.php';?>
                </tbody>
                <tfoot>
                  <tr>
