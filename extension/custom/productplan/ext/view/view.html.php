          ...
          <table class='table has-sort-head' id='bugList'>
            ...
            <thead>
              <tr class='text-center'>
                ...
                <th class='text-left'><?php common::printOrderLink('title', $orderBy, $vars, $lang->bug->title);?></th>
                <th class='c-severity' title='<?php echo $lang->bug->severity;?>'><?php common::printOrderLink('severity', $orderBy, $vars, $lang->bug->severity);?></th>
            ...
            <tbody class='text-center'>
              ...
              <tr>
                ...
                <td>
                  ...
                  ?>
                  <div class='c-severity'>
                    <span class='<?php echo $severityClass; ?>' data-severity='<?php echo $bug->severity; ?>' title='<?php echo $severityValue; ?>'>
                      <?php echo $bugSeverity; ?>
                    </span>
                  </div>
                </td>
                <td><span class='<?php echo $bug->pri ? "label-pri label-pri-{$bug->pri}" : "";?>' title='<?php echo zget($lang->bug->priList, $bug->pri);?>'><?php echo zget($lang->bug->priList, $bug->pri);?></span></td>
