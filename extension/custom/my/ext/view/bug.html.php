    ...
    <table class="table has-sort-head table-fixed" id='bugList'>
      ...
      <thead>
        <tr>
          ...
          <th class='c-project'><?php common::printOrderLink('project', $orderBy, $vars, $lang->bug->project);?></th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class='text-left nobr'>
            <?php echo (isset($bug->projectName) && $bug->projectName) ? html::a($this->createLink('project', 'browse'), $bug->projectName, null, "title={$bug->projectName}") : '';?>
          </td>
          <?php if($type != 'openedBy'): ?>
