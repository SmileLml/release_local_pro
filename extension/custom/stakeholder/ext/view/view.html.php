...
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-right">
    <?php if(common::hasPriv('stakeholder', 'create') and (!isset($canBeChanged) or $canBeChanged)) echo html::a($createLink, "<i class='icon icon-plus'></i> {$lang->stakeholder->create}", '', "class='btn btn-primary' data-app=$app->tab");?>
  </div>
</div>
<div class="main-row" id="mainContent">
  <div class="main-col col-8">
    ...
    <div class="cell" id="communicate"><?php include $app->getModuleRoot() . 'common/view/action.html.php';?></div>
  </div>
