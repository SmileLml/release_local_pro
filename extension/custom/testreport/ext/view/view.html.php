...
<div id='mainContent' class='main-content'>
  ...
  <div class='tab-content'>
    ...
    <div class='tab-pane' id='storyAndBug'>
      <?php include $app->getModulePath() . 'view/blockstories.html.php'?>
      <?php include $app->getModulePath() . 'view/blockbugs.html.php'?>
    </div>
    <div class='tab-pane' id='tabBuild'><?php include $app->getModulePath() . 'view/blockbuilds.html.php'?></div>
    <div class='tab-pane' id='tabCase'><?php include $app->getModulePath() . 'view/blockcases.html.php'?></div>
    <div class='tab-pane' id='tabLegacyBugs'><?php include $app->getModulePath() . 'view/blocklegacybugs.html.php'?></div>
    <div class='tab-pane active' id='tabReport'><?php include $app->getModulePath() . 'view/blockbugreport.html.php'?></div>
    ...
    <?php if(!$this->session->notHead):?>
    <div class='tab-pane' id='tabHistory'><?php include $app->getModuleRoot() . 'common/view/action.html.php';?></div>
    <?php if($this->app->user->admin):?>
