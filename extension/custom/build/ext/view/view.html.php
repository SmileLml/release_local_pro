...
if($app->tab == 'execution' or $app->tab == 'project')
{
  $canBeChangedProject = common::canModify('project', $project);
}
js::set('canBeChangedProject', $canBeChangedProject);
?>
  ...
  <div class='tabs' id='tabsNav'>
    ...
    <div class='tab-content'>
      <div class='tab-pane <?php if($type == 'story') echo 'active'?>' id='stories'>
        <?php if($canBeChanged and $canBeChangedProject and common::hasPriv($module, 'linkStory') and !isonlybody()):?>
        ...
        <form class='main-table table-story<?php if($link === 'true' and $type == 'story') echo " hidden";?>' data-ride='table' method='post' target='hiddenwin' action='<?php echo $this->createLink($module, 'batchUnlinkStory', "buildID={$build->id}")?>' id='linkedStoriesForm'>
          <table class='table has-sort-head' id='storyList'>
            <?php $canBatchUnlink = ($canBeChanged and $canBeChangedProject and common::hasPriv($module, 'batchUnlinkStory'));?>
      ...
      <div class='tab-pane <?php if($type == 'bug') echo 'active'?>' id='bugs'>
        <?php if($canBeChanged and $canBeChangedProject and common::hasPriv($module, 'linkBug') and !isonlybody()):?>
