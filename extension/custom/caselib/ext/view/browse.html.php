    ...
    ?>
      <div class='btn-group'>
        ...
        <ul class='dropdown-menu pull-right' id='exportActionMenu'>
          <?php
          $class = common::hasPriv('caselib', 'exportCase') ? '' : "class=disabled";
          $misc  = common::hasPriv('caselib', 'exportCase') ? "class='export'" : "class=disabled";
          $link  = common::hasPriv('caselib', 'exportCase') ?  $this->createLink('caselib', 'exportCase', "libID=$libID&orderBy=$orderBy&browseType=$browseType") : '#';
          echo "<li $class>" . html::a($link, $lang->caselib->exportCase, '', $misc . "data-app={$this->app->tab}") . "</li>";

          $class = common::hasPriv('caselib', 'exportTemplate') ? '' : "class=disabled";
          $misc  = common::hasPriv('caselib', 'exportTemplate') ? "class='export'" : "class=disabled";
          $link  = common::hasPriv('caselib', 'exportTemplate') ?  $this->createLink('caselib', 'exportTemplate', "libID=$libID") : '#';
          echo "<li $class>" . html::a($link, $lang->caselib->exportTemplate, '', $misc . "data-app={$this->app->tab} data-width='40%'") . "</li>";
          ?>
        </ul>
      </div>
      <div class='btn-group'>
