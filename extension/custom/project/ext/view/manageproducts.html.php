        ...
        <div class='detail-content row'>
          ...
          <?php foreach($linkedProducts as $productID => $linkedProduct):?>
            <?php foreach($linkedBranches[$productID] as $branchID):?>
              ...
              <?php if(!common::canModify('project', $project)) $disabled = "disabled='disabled'"; ?>
              <div class='col-sm-4'>
              ...
              <div class='col-sm-4'>
                <div class='product<?php echo isset($branchGroups[$productID]) ? ' has-branch' : ''?>'>
                  <div class="checkbox-primary" title='<?php echo $productName;?>'>
                    <?php echo "<input type='checkbox' name='products[$i]' value='$productID' id='products{$productID}' " . (!common::canModify('project', $project) ? "disabled='disabled'" : " ")  .  " >";?>
