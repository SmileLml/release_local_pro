    ...
    <table class='table table-form'>
      <thead>
        <tr class='text-center'>
          ...
          <?php if(common::canModify('project', $project)):?><th class="c-actions"><?php echo $lang->actions;?></th><?php endif;?>
        </tr>
      </thead>
      <tbody>
      <?php $i = 0;?>
      ...
      <?php unset($users[$member->account]);?>
        <tr>
          ...
          <td><?php echo html::input("roles[$i]", $member->role, !common::canModify('project', $project) ? "class='form-control' readonly" : "class='form-control'");?></td>
          <td><?php echo html::input("days[$i]", $member->days, !common::canModify('project', $project) ? "class='form-control' readonly" : "class='form-control'");?></td>
          <td>
            <?php echo html::input("hours[$i]", $member->hours, !common::canModify('project', $project) ? "class='form-control' readonly" : "class='form-control'");?>
            <?php echo html::hidden("accounts[$i]", $member->account);?>
          </td>
          <td><?php echo html::radio("limited[$i]", $lang->team->limitedList, $member->limited, !common::canModify('project', $project) ? "disabled" : "");?></td>
          <?php if(common::canModify('project', $project)):?>
            ...
            <tr>
                <td colspan='6' class='text-center form-actions'>
                    <?php
                        ...
                        elseif(common::canModify('project', $project))
                        {
