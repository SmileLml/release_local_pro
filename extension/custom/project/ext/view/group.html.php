...
<div id='mainMenu' class='clearfix'>
  ...
  <div class='btn-toolbar pull-right'>
    <?php if(common::hasPriv('project', 'createGroup') and $canBeChanged) echo html::a($this->createLink('project', 'createGroup', "projectID=$projectID&projectID=$projectID", '', true), '<i class="icon-plus"></i> ' . $lang->group->create, '', 'class="btn btn-primary iframe" data-width="550"');?>
  </div>
</div>
