...
<?php
  $canBeChanged = true;
  if($fromModule == 'projectbuild' and $fromMethod == 'browse')
  {
...
<div id="mainMenu" class="clearfix table-row">
  ...
  <div class="btn-toolbar pull-right">
    <?php if($canBeChanged) common::printLink('projectbuild', 'create', "projectID=$projectID", "<i class='icon icon-plus'></i> " . $lang->build->create, '', "class='btn btn-primary' id='createBuild'");?>
  </div>
</div>
<div id="mainContent">
