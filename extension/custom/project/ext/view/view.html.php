        ...
        <div class="panel block-team" style="height: 280px">
          ...
          <div class="panel-body">
            <div class="row row-grid">
              ...
              <?php endforeach;?>
              <div class="col-xs-6">
                <?php if(common::canModify('project', $project)) common::printLink('project', 'manageMembers', "projectID=$project->id", "<i class='icon icon-plus hl-primary text-primary'></i> &nbsp;" . $lang->project->manageMembers, '', "class='text-muted'");?>
              </div>
            </div>
          </div>
        </div>
