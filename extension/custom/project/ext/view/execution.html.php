...
<?php js::set('canBeChange', $canBeChange);?>
...
<div id='mainMenu' class='clearfix'>
  <div class='btn-toolbar pull-left'>
    ...
    <?php endforeach;?>
    <?php if(common::hasPriv('execution', 'batchEdit') and !empty($executionStats) and $canBeChange) echo html::checkbox('editExecution', array('1' => $lang->edit . $lang->executionCommon), '', $this->cookie->editExecution ? 'checked=checked' : '');?>
    <?php if(common::hasPriv('execution', 'task') and $canBeChange) echo html::checkbox('showTask', array('1' => $lang->programplan->stageCustom->task), '', $this->cookie->showTask ? 'checked=checked' : '');?>
...
<div id='mainContent' class="main-row fade">
  ...
  <?php else:?>
    <?php $canBatchEdit = common::hasPriv('execution', 'batchEdit') && $canBeChange; ?>
