...
<div class='clearfix' id='mainMenu'>
  ...
  <div class='btn-toolbar pull-right'>
    <?php if(common::canModify('project', $project)) common::printLink('execution', 'create', "projectID=$project->id", '<i class="icon icon-plus"></i> ' . $lang->project->createKanban, '', 'class="btn btn-primary" data-app="execution"');?>
  </div>
</div>
<div id="mainContent">
  <div class="row cell" id='cards'>
    ...
    <div class="table-empty-tip">
      <p>
        ...
        <?php if(common::canModify('project', $project)) common::printLink('execution', 'create', "projectID=$project->id", '<i class="icon icon-plus"></i> ' . $lang->project->createKanban, '', 'class="btn btn-info" data-app="execution"');?>
      </p>
    </div>
    <?php else:?>
    <?php $kanbanCount = 0;?>
    ...
    <div class='col' data-id='<?php echo $kanbanID?>'>
      <div class='panel' data-url='<?php echo $this->createLink('execution', 'kanban', "kanbanID=$kanbanID");?>'>
        <div class='panel-heading'>
           ...
           $kanbanCount ++;
           ?>
           <?php if($canActions and common::canModify('project', $project)):?>
