...
class company extends control
{
    ...
    public function effort($date = 'today', $orderBy = 'date_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        ...
        if(strpos($orderBy, 'projectStatus_') !== false) $orderBy = str_replace('projectStatus_', 't3.status_', $orderBy);
        /* Set the pager. */
        ...
        /* Get users.*/
        $users      = array('' => '') + $this->loadModel('dept')->getDeptUserPairs($dept, '', '', 'withdeleted');
