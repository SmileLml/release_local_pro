...
if(!$canBeChangedByProject)
{
  ...
  foreach($tasks as $rowKey => $rowValue)
  {
    unset($tasks[$rowKey]->actions);
  }
}
...
<div id="mainMenu" class="clearfix">
  ...
  <?php if(!isonlybody()): ?>
    <div class="btn-toolbar pull-right">
      ...
      <?php if(common::canModify('execution', $execution, $project)):?>
        <div class="btn-group dropdown-hover">
    ...
    <?php else:?>
      <form class="main-table table-task skip-iframe-modal not-watch" method="post" id='executionTaskForm'>
        ...
        <div class="table-footer">
          <?php if($canBatchAction && $canBeChangedByProject):?>
