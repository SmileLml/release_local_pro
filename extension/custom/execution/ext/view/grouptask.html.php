...
<?php $canBeChangedByProject = common::canModify('execution', $execution, $project);?>
  <div id="mainMenu" class="clearfix table-row">
    ...
    <div class="btn-toolbar pull-right">
      ...
      if(common::hasPriv('task', 'create', $checkObject) and $canBeChangedByProject) echo html::a($link, "<i class='icon icon-plus'></i> {$lang->task->create}", '', "class='btn btn-primary'");
      ?>
    </div>
  </div>
    ...
    <?php if(empty($tasks)):?>
      <div class="table-empty-tip">
        <p>
          ...
          <?php if(common::hasPriv('task', 'create', $checkObject) and $canBeChangedByProject):?>
