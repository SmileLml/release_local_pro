...
<div id="mainMenu" class="clearfix main-row fade in">
  ...
  <div class="btn-toolbar pull-right">
    <?php if(common::canModify('execution', $execution, $project)) echo html::a(helper::createLink('testcase', 'create', "productID=$productID&branch=0&moduleID=0&from=execution&param=$execution->id", '', '', '', true), "<i class='icon icon-plus'></i> " . $lang->testcase->create, '', "class='btn btn-primary' data-app='{$this->app->tab}'");?>
  </div>
</div>
    ...
    <?php if(empty($cases)):?>
      <div class="table-empty-tip">
        <p>
          ...
          <?php if(common::canModify('execution', $execution, $project) and common::hasPriv('testcase', 'create')):?>
          ...
          <?php foreach($cases as $case):?>
            ...
            <tr>
              ...
              <td class='c-actions'>
                ...
                $case->canAction  = common::canModify('project', $project);
