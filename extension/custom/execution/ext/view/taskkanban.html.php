...
js::set('priv',
  array(
    ...
    'canAssignTask'       => common::hasPriv('task', 'assignto') && $canBeChanged,
    'canAssignStory'      => common::hasPriv('story', 'assignto') && $canBeChanged,
    'canFinishTask'       => common::hasPriv('task', 'finish') && $canBeChanged,
    'canPauseTask'        => common::hasPriv('task', 'pause') && $canBeChanged,
    'canCancelTask'       => common::hasPriv('task', 'cancel') && $canBeChanged,
    'canCloseTask'        => common::hasPriv('task', 'close') && $canBeChanged,
    'canActivateTask'     => common::hasPriv('task', 'activate') && $canBeChanged,
    'canStartTask'        => common::hasPriv('task', 'start') && $canBeChanged,
    'canAssignBug'        => common::hasPriv('bug', 'assignto') && $canBeChanged,
    'canConfirmBug'       => common::hasPriv('bug', 'confirmBug') && $canBeChanged,
    'canActivateBug'      => common::hasPriv('bug', 'activate') && $canBeChanged,
    'canCloseStory'       => common::hasPriv('story', 'close') && $canBeChanged,
  )
);
?>
