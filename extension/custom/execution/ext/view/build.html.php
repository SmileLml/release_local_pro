...
<?php $canBeChanged = common::canModify('project', $project); ?>
<div id="mainMenu" class="clearfix table-row">
  ...
  <div class="btn-toolbar pull-right">
    <?php if(common::canModify('execution', $execution, $project)) common::printLink('build', 'create', "execution=$execution->id", "<i class='icon icon-plus'></i> " . $lang->build->create, '', "class='btn btn-primary'");?>
  </div>
</div>
<div id="mainContent">
  ...
  <?php if(empty($executionBuilds)):?>
    <div class="table-empty-tip">
      <p>
        ...
        <?php if(common::canModify('execution', $execution, $project) and common::hasPriv('build', 'create')):?>
