...
<div id="mainMenu" class="clearfix table-row">
  ...
  <div class="btn-toolbar pull-right">
    ...
    if(common::hasPriv('task', 'create', $checkObject) and common::canModify('execution', $execution)) echo html::a($link, "<i class='icon icon-plus'></i> {$lang->task->create}", '', "class='btn btn-primary'");
    ?>
  </div>
</div>
<div id='tasksTable' class='main-table load-indicator loading' data-ride='table' data-checkable='false' data-group='true' data-hot='true'>
  ...
  <div class="table-empty-tip">
    <p>
      ...
      <?php if(common::hasPriv('task', 'create', $checkObject) and common::canModify('execution', $execution)):?>
