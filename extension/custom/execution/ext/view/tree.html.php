...
<?php $canBeChangedByProject = common::canModify('execution', $execution);?>
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-right">
    ...
    if($canBeChangedByProject) echo html::a($link, "<i class='icon icon-plus'></i> " . $lang->task->create, '', $misc);
    ?>
  </div>
</div>
