...
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-right">
    <?php $canBeChanged ? common::printLink('projectrelease', 'create', "projectID=$projectID", "<i class='icon icon-plus'></i> {$lang->release->create}", '', "class='btn btn-primary'") : '';?>
  </div>
</div>
<div id="mainContent" class='main-table'>
  ...
  <div class="table-empty-tip">
    <p>
      ...
      <?php if(common::hasPriv('projectrelease', 'create') and $canBeChanged):?>
  ...
  <table class="table table-bordered table-condensed" id='releaseList'>
    <thead>
      <tr>
        ...
        ?>
        <?php if($canBeChanged): ?><th class='c-actions-6 text-center'><?php echo $lang->actions;?></th><?php endif; ?>
      </tr>
    </thead>
    <tbody>
      ...
      <tr data-type='<?php echo $release->status;?>'>
        ...
        <?php if($canBeChanged):?><td <?php echo $rowspan?> class='c-actions'><?php echo $this->projectrelease->buildOperateMenu($release, 'browse');?></td><?php endif;?>
        <?php endif;?>
      </tr>
      <?php $i++; ?>
      <?php endforeach;?>
