...
<div id='mainMenu' class='clearfix'>
  ...
  <div class='btn-toolbar pull-right'><?php echo $canModify ? $this->projectrelease->buildOperateMenu($release, 'view') : '';?></div>
</div>
    ...
    <div class='main'>
      <div class='tabs' id='tabsNav'>
        ...
        <ul class='nav nav-tabs'>
          ...
          <li class='pull-right' style="<?php echo !$canModify ? 'margin-right:0px' : ''; ?>"><div><?php common::printIcon('projectrelease', 'export', "releaseID=$release->id", '', 'button', '', '', "export btn-sm");?></div></li>
          <?php endif;?>
        </ul>
        <div class='tab-content'>
          <div class='tab-pane <?php if($type == 'story') echo 'active'?>' id='stories'>
            <?php if(common::hasPriv('projectrelease', 'linkStory') and $canBeChanged and !isonlybody() and $canModify):?>
              ...
              <table class='table has-sort-head' id='storyList'>
                ...
                <thead>
                  <tr class='text-center'>
                    ...
                    <?php if($canModify):?><th class='c-actions-1'><?php echo $lang->actions?></th><?php endif;?>
                  </tr>
                </thead>
          ...
          <div class='tab-pane <?php if($type == 'bug') echo 'active'?>' id='bugs'>
            ...
            <div class='actions'><?php echo $canModify ? html::a("javascript:showLink({$release->id}, \"bug\")", '<i class="icon-bug"></i> ' . $lang->release->linkBug, '', "class='btn btn-primary'") : '';?></div>
            <div class='linkBox cell hidden'></div>
            <?php endif;?>
              ...
              <table class='table has-sort-head' id='bugList'>
                ...
                <thead>
                  <tr class='text-center'>
                    ...
                    <?php if($canModify):?><th class='w-60px'>   <?php echo $lang->actions;?></th><?php endif;?>
                  </tr>
                </thead>
                <tbody class='text-center'>
          ...
          <div class='tab-pane <?php if($type == 'leftBug') echo 'active'?>' id='leftBugs'>
            <?php if(common::hasPriv('projectrelease', 'linkBug') and $canBeChanged and !isonlybody()):?>
            <div class='actions'><?php echo $canModify ? html::a("javascript:showLink({$release->id}, \"leftBug\")", '<i class="icon-bug"></i> ' . $lang->release->linkBug, '', "class='btn btn-primary'") : '';?></div>
            <div class='linkBox cell hidden'></div>
            <?php endif;?>
