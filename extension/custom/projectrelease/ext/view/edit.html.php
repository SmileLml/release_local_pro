      ...
      <table class='table table-form'>
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo html::select('build[]', $builds, $release->build, "class='form-control chosen' multiple disabled data-placeholder='{$lang->build->placeholder->multipleSelect}'"); ?></td><td></td>
          </tr>
          <tr>
