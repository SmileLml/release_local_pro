...
$config->excel->sysDataField = array('module', 'project', 'execution', 'plan', 'build', 'branch', 'assignedTo', 'story', 'task', 'openedBuild', 'reviewedBy', 'needReview', 'product', 'notify', 'public', 'mailto', 'dept');
