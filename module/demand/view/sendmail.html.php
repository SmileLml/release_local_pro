<?php
/**
 * The mail file of demand module of ZenTaoPMS.
 *
 * @copyright   Copyright 2009-2024 禅道软件（青岛）有限公司(ZenTao Software (Qingdao) Co., Ltd. www.cnezsoft.com)
 * @license     ZPL(http://zpl.pub/page/zplv12.html) or AGPL(https://www.gnu.org/licenses/agpl-3.0.en.html)
 * @author      Fangzhou Hu <hufangzhou@easycorp.ltd>
 * @package     demand
 * @version     $Id: sendmail.html.php 4129 2024-01-04 14:12:14Z hufangzhou $
 * @link        https://www.zentao.net
 */
?>
<?php $mailTitle = 'DEMAND #' . $object->id . ' ' . $object->title;?>
...
<tr>
  <td style='padding: 10px; border: none;'>
    <fieldset style='border: 1px solid #e5e5e5'>
      <legend style='color: #114f8e'><?php echo $this->lang->demand->spec;?></legend>
