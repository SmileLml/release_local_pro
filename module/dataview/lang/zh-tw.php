...
$lang->dataview->errorField     = '當前欄位%s為非法字元,請[as]成英文或英文下劃線的格式。';
$lang->dataview->queryFilterTip = '查詢篩選器是通過在 SQL 中插入變數實現動態查詢的篩選方式，第三步配置的結果篩選器是對SQL查詢結果進行進一步篩選。';
...
$lang->dataview->objects['feedback']    = '反饋';
$lang->dataview->objects['action']      = '動態';
$lang->dataview->objects['effort']      = '日誌';
