    ...
    <table class='table table-form'>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class='text-left<?php echo zget($visibleFields, 'assignedTo', ' hidden')?>'><?php echo html::select("assignedTo[$storyID]", array($story->assignedTo => $users[$story->assignedTo]), $story->assignedTo, "class='form-control picker-select' data-drop-width='auto'");?></td>
          ...
          <td class='text-left<?php echo zget($visibleFields, 'closedBy', ' hidden')?>'><?php echo html::select("closedBys[$storyID]", array($story->assignedTo => $users[$story->assignedTo]), $story->closedBy, "class='form-control" . ($story->status == 'closed' ? " picker-select' data-drop-width='auto'" : "' disabled='disabled'"));?></td>
