  ...
  <div class="container" id="login">
    <div id="loginPanel">
      <div class="table-row">
          ...
          <form method='post' target='hiddenwin' id='loginForm'>
            <table class='table table-form'>
              <tbody>
                ...
                <tr>
                 <th><?php echo $lang->user->realm;?></th>
                 <td><select name="realm" id="realm"><option value="local">本地</option><option value="kydc" <?php if ($realm=='kydc') echo 'selected="selected"'; ?>>终端研发统一认证</option></select></td>
                </tr>
		    ...
		    //echo html::a($resetLink, $lang->user->resetPassword);
                   ?>
                  |
                  <a href="https://172.20.191.29/reset" target="_blank">统一认证注册或找回</a>
                  </td>
                </tr>
                <tr>
		...
		<tr>
			<td class="form-actions" colspan='2' style="padding-top: 2px"><a style="width:100%" class="btn btn-primary" href="https://oauth.kylin.com/auth/sso_proxy/login_for_zentao" >麒麟软件统一安全认证登录</a></td>
		</tr>
              </tbody>
            </table>
          </form>
